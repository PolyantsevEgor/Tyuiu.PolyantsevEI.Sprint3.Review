...
using Tyuiu.PolyantsevEI.Sprint3.TaskReview.V10.Lib;

namespace Tyuiu.PolyantsevEI.Sprint3.TaskReview.V10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #3 | Выполнила: Полянцев Е. И. | ИСТНб-23-1";
            Console.WriteLine("***************************************************************************");
